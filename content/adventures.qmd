...
```{.random-table}
caption: How the story begins…
columns: [d66, beginning]
rows:
...
```{.random-table}
caption: The opponent…
columns: [d66, opponent]
rows:
...
```{.random-table}
caption: Some unwelcome complications
columns: [d26, complication]
rows:
...
```{.random-table}
caption: What they want
columns: [d6, what they want]
rows:
...
```{.random-table}
caption: Opponents or competitors
columns: [d26, opponent or competitor]
rows:
...
```{.random-table}
caption: A good reason to give up
columns: [d6, reason]
rows:
